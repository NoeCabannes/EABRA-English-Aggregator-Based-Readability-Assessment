...
data = {
    ...
    ] # triple quotes are essential here because they allow to include quotation marks inside the string, and allow line break. both are frequently included in the CLEAR Corpus.
}
